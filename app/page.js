  ...
  const reviews = [
    {
      ...
      stars: 5,
      text: "Absolutely incredible experience! Our guide was knowledgeable, passionate, and made us feel safe throughout the Serengeti safari. Kijeda Tour exceeded every expectation.",
    },
    {
      name: "James Okonkwo",
      country: "Nigeria",
      ...
      stars: 5,
      text: "The Zanzibar package was a dream. Stone Town, Nungwi Beach — everything was perfectly organized. I will definitely be back with my family.",
    },
    {
      name: "Anika Müller",
      country: "Germany",
      ...
      stars: 5,
      text: "Climbing Kilimanjaro with Kijeda Tour was the best decision of my life. Professional crew, great gear, and constant encouragement all the way to the summit.",
    },
    {
      name: "Carlos Rivera",
      country: "Spain",
      ...
      stars: 5,
      text: "Kigamboni Beach day trip was so relaxing and well-organized. The fresh seafood they arranged for us was unforgettable. Highly recommend!",
    },
    {
      ...
      stars: 5,
      text: "From booking to departure, the team at Kijeda Tour was responsive and professional. The Ngorongoro Crater tour left us speechless.",
    },
  ];
    ...
    <div className="w-full">
      ...
      <div className="bg-[#1A3C34] text-white py-2 px-8 hidden lg:flex justify-between items-center text-xs">
        <div className="flex gap-6">
          <a href="tel:+255773753292" className="flex items-center gap-1.5 hover:text-emerald-300 transition-colors duration-200">
            <FaPhone className="text-sm" />
            +255 773 753 292
          </a>
          <a href="https://wa.me/255773753292?text=Habari%20Kijeda%20Tour!" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-emerald-300 transition-colors duration-200">
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={toggleTheme}
            className="flex items-center gap-2 bg-white/10 hover:bg-white/25 transition-all duration-200 px-3 py-1.5 rounded-full text-white text-xs font-medium"
          >
            {darkMode ? (
              <>
                <svg className="h-3.5 w-3.5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div className={`flex items-center overflow-hidden transition-all duration-300 rounded-full border ${searchOpen ? 'w-56 border-amber-600 bg-white shadow-md' : 'w-10 border-transparent bg-transparent'}`}>
              {searchOpen && (
                <input
                  ...
                  className="flex-1 pl-4 pr-2 py-2 text-sm bg-transparent outline-none text-gray-700"
                />
              )}
              <button
                onClick={() => setSearchOpen(!searchOpen)}
                className="w-10 h-10 flex items-center justify-center rounded-full bg-amber-700 hover:bg-amber-800 text-white transition-colors duration-200 shrink-0"
              >
      ...
      <section id="dar-tour" className="bg-[#f5f5f0] py-16 px-6 md:px-16">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="group bg-[#f9f8f5] rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Habari%20Kijeda%20Tour!%20Ninapenda%20kujua%20zaidi%20kuhusu%20Kilimanjaro%20Expedition." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
          ...
          <div className="group bg-[#f9f8f5] rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Habari%20Kijeda%20Tour!%20Ninapenda%20kujua%20zaidi%20kuhusu%20Kigamboni%20Beach." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
          ...
          <div className="group bg-[#f9f8f5] rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Habari%20Kijeda%20Tour!%20Ninapenda%20kujua%20zaidi%20kuhusu%20Bongoyo%20Island." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
          ...
          <div className="group bg-[#f9f8f5] rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Habari%20Kijeda%20Tour!%20Ninapenda%20kujua%20zaidi%20kuhusu%20Mlimani%20City." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Hello%20Kijeda%20Tour!%20I%20am%20interested%20in%20the%20Nungwi%20Beach%20tour." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
          ...
          <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Hello%20Kijeda%20Tour!%20I%20am%20interested%20in%20the%20Stone%20Town%20tour." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
          ...
          <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Hello%20Kijeda%20Tour!%20I%20am%20interested%20in%20the%20Kendwa%20Beach%20tour." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
          ...
          <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-3 flex-1">
              ...
              <a href="https://wa.me/255773753292?text=Hello%20Kijeda%20Tour!%20I%20am%20interested%20in%20the%20Paje%20Lagoon%20tour." target="_blank" rel="noopener noreferrer" className="mt-auto text-amber-700 font-semibold text-sm hover:text-amber-900 transition-colors duration-200">
                Book this tour ↗
              </a>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="group relative rounded-2xl overflow-hidden h-72 cursor-pointer">
            ...
            <div className="absolute bottom-5 left-5">
              <p className="text-amber-400 text-xs font-semibold uppercase tracking-widest flex items-center gap-1 mb-1">📍 Tanzania</p>
...
{/* Reviews */}
      <section id="reviews" className="bg-[#f5f5f0] py-16 px-6 md:px-16">
        ...
        <div className="max-w-2xl mx-auto relative">
          {/* Card */}
          <div className="bg-[#f9f8f5] rounded-2xl px-10 py-10 flex flex-col items-center text-center gap-5 shadow-sm min-h-[320px] transition-all duration-500">
            <img
          ...
          <button
            onClick={prev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 w-11 h-11 rounded-full bg-white border border-gray-200 shadow flex items-center justify-center text-gray-600 hover:bg-amber-700 hover:text-white transition-colors duration-200"
          >
            ‹
          </button>
          ...
          <button
            onClick={next}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 w-11 h-11 rounded-full bg-white border border-gray-200 shadow flex items-center justify-center text-gray-600 hover:bg-amber-700 hover:text-white transition-colors duration-200"
          >
            ›
          </button>
          ...
          <div className="flex justify-center gap-2 mt-6">
            {reviews.map((_, i) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${i === current ? 'bg-amber-700 w-6' : 'bg-gray-300'}`}
              />
            ))}
          </div>
        </div>
